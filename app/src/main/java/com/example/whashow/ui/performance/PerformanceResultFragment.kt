...
class PerformanceResultFragment : BaseFragment<FragmentRecommandResultBinding>(R.layout.fragment_recommand_result) {
    ...
    override fun initDataBinding() {
        ...
        spinnerSortResult.adapter = SortResultSpinnerAdapter(
            requireContext(),
                                        ...
                                        if (data != null) {
                                            ...
                                            recommandResultViewModel.reviewList.observe(
                                                ...
                                                Observer { list ->
                                                    ...
                                                    performanceReviewAdapter.updatePairId(pairId)
                                                    performanceReviewAdapter.updateReviews(list)
            ...
            override fun onPageSelected(position: Int) {
                ...
                recommandViewModel.recommandResultList.observe(viewLifecycleOwner) { list ->
                    ...
                    if (position >= 0 && position < performanceViewPager.performanceList.size) {
                        val performancesByStandardList =
                            performanceViewPager.performanceList[position].performancesByStandard
                        ...
                        if (performancesByStandardList.isNotEmpty()) {
                            ...
                            Log.d(
                                "Error",
                                "performancesByStandard list is empty at position $position."
                            )
                        ...
                        Log.d(
                            "Error",
                            "Invalid position: $position. performanceList size: ${performanceViewPager.performanceList.size}."
                        )
                        // 예외 처리 코드 추가 (예: 기본 ID 설정 또는 경고 메시지 표시)
                    }
                }
