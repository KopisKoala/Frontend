...
class PerformanceReviewAdapter (var list: ArrayList<PerformanceResultDTOList>,var id:Int): RecyclerView.Adapter<PerformanceReviewAdapter.ReviewViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): PerformanceReviewAdapter.ReviewViewHolder{
    ...
    override fun onBindViewHolder(holder: PerformanceReviewAdapter.ReviewViewHolder, position: Int) {
        ...
        holder.checked.setOnClickListener {
            ...
            val Call2: Call<ReviewLike> =
                ApiManager.reviewService.deleteLike(
        ...
        holder.unchecked.setOnClickListener {
            ...
            val Call2: Call<ReviewLike> =
                ApiManager.reviewService.postLike(
                    "Bearer " + LocalDataSource.getAccessToken()!!, id
                )
            // 비동기적으로 요청 수행
            Call2.enqueue(object : Callback<ReviewLike> {
