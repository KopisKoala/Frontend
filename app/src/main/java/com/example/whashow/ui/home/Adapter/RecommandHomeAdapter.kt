...
import com.example.whashow.ui.home.Recommand

class RecommandHomeAdapter(var list: ArrayList<Recommand>) : RecyclerView.Adapter<RecommandHomeAdapter.RecommandHomeHodler>(){

    var RecommandList: ArrayList<Recommand> =list
        set(value){
            field=value
    ...
    inner class RecommandHomeHodler(val binding: ListGridRecommandItemBinding) :
    ...
    override fun onBindViewHolder(holder: RecommandHomeHodler, position: Int) {
    ...
    override fun getItemCount(): Int {
        return minOf(list.size, 2)  // 최대 5개의 아이템만 표시
    }
