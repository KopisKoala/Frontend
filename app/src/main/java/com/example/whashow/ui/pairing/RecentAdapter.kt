...
class RecentAdapter (var list: ArrayList<RecentPairing>): RecyclerView.Adapter<RecentAdapter.RecentViewHolder>() {

    var recentList: ArrayList<RecentPairing> =list
        set(value){
            field=value
    ...
    override fun onCreateViewHolder(
        ...
        return RecentViewHolder(
            ListRecentPairingBinding.inflate(
    ...
    inner class RecentViewHolder(val binding: ListRecentPairingBinding) :
